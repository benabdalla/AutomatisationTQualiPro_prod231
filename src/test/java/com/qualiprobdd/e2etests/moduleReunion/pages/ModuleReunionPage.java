package com.qualiprobdd.e2etests.moduleReunion.pages;
...
public class ModuleReunionPage extends AbstractPage {

	public ModuleReunionPage(WebDriver driver) {
	...
	@FindBy(how = How.ID, using = CHOIX_EMPL_ID)
	public static WebElement choixEmplID;
