Feature: QualiPro-TestModuleIndicateur
  ...
  Scenario Outline: QualiPro-Test Suivi indicateur manuel
    ...
    And saisir <valeur> indicateur
    And saisir rapport
    And rattacher fichier joint
    ...
    Examples:
      ...
      | 1           | 1       | "Indicateur" | "01"        | "2019" | "100"  | "Target met"     |
      | 1           | 1       | "Indicateur" | "01"        | "2020" | "90"   | "Target met"     |
      | 1           | 1       | "Indicateur" | "02"        | "2020" | "200"  | "Target not met" |
