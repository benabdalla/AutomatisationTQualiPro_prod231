...
features = { "src/specs/features/Documentation/CreationDocSpirale.feature" }, 
monochrome =true,
plugin = {"html:target/cucumber-html-report", "json:target/cucumber.json", "junit:target/cucumber.xml",
"com.cucumber.listener.ExtentCucumberFormatter:target/cucumber-reports/report.html" },
tags = {"@DocumentaionSpiraleAvecReporting"},
dryRun= false	
		)

@Test
public class DocSpiraleReportingRunner extends AbstractTestNGCucumberTests {
