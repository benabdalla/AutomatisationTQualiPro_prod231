...
public class DemandeActionModel {
	...
	public static void  Selectionner_Date_Creation(WebDriver driver) throws Throwable
	{
		...
		actions.moveToElement(DemandeActionPage.dateCreationID).click().perform();
		//WebDriverWait wait = new WebDriverWait(driver,60);
        //wait.until(ExpectedConditions.visibilityOf(DemandeActionPage.CalendrierID));
		actions.moveToElement(DemandeActionPage.CalendrierID).click().build().perform();
		//JavascriptExecutor  executor = (JavascriptExecutor)driver;
		//executor.executeScript("arguments[0].click()", DemandeActionPage.dateCreationID);
		//Thread.sleep(200);
		//DemandeActionPage.dateCreationID.click();
		//WebDriverWait wait = new WebDriverWait(driver,30);
        //wait.until(ExpectedConditions.elementToBeClickable(DemandeActionPage.CalendrierID));
		//DemandeActionPage.CalendrierID.click();
		//JavascriptExecutor executor = (JavascriptExecutor)driver;
		//executor.executeScript("arguments[0].click()", DemandeActionPage.CalendrierID);
	}
	...
	{
		DemandeActionPage.DescriptionID.sendKeys("description demande action "+RandomValue.randomString(10));
	}
	
	public static void  Saisir_Cause() 
	{
		DemandeActionPage.CauseID.sendKeys("Cause demande action "+RandomValue.randomString(10));
	}
	...
	public static void saisirDesignationSAD(WebDriver driver) throws InterruptedException {
		Thread.sleep(3000L);
		String  st="Désignation sous action réalisé par autotest "+RandomValue.randomString(10);
		System.out.println(" designation  "+st);
		JavascriptExecutor jse = (JavascriptExecutor)driver;
		jse.executeScript("arguments[1].value = arguments[0];",st,DemandeActionPage.designation_SAD_ID);
